...
- Runtime client: src/runtimeConfig.js resolves API_BASE at runtime from multiple sources
...
The runtime configuration flow ensures that the frontend always knows where to call the backend, even behind proxies or tunnels.
